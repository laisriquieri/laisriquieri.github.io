...
(function($) {
    ...
    function isubmitForm() {
        ...
        console.log(name) 
        console.log(message)
        window.open(`https://api.whatsapp.com/send?phone=5516994172857&text=Olá%20meu%20nome%20é%20${name}%20${message}`)
	}
    ...
    function csubmitForm() {
        ...
        var url = `https://api.whatsapp.com/send?phone=5516994172857&text=Olá%20meu%20nome%20é%20${name}%20${email}%20${message}`;
    }
